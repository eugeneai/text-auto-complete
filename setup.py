...
ext_modules=[
#    Extension("isu.autocomplete.cython_module",
#              sources=["src/./isu.autocomplete/cython_module.pyx"],
#              libraries=["gdal"],
#    )
]

setup(
    name='isu.autocomplete',
    version=version,
    description="Autocomplete package",
    ...
    #     """.split('\n') if c.strip()],
    # ],
    keywords='autocomplete isu-enterprise',
    author='Evgeny Cherkashin',
    author_email='eugeneai@irnok.net',
    url='https://github.com/isu-enterprise/isu.autocomplete',
    license='GPL>=2.0',
    ...
    entry_points={
        'console_scripts':
            ['isu.autocomplete=isu.autocomplete:main']
    },
